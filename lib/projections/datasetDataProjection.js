...
exports.Projection = (function() {
  ...
  var dataCreate = function(data) {
    delete data._id;
    var newRow = this._DataModel(data);
  ...
  DatasetDataProjection.prototype.start = Promise.method(function(datasetModel) {
    log("starting");
    this._dataset = datasetModel;
    this._DataModel = dynamicModelFactory(this._dataset.store, datasetModel.scheme, datasetModel.uniqueIndex);
