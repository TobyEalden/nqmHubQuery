...
module.exports = (function() {
  ...
  var log = require("debug")("nqmQuery:eventBusClient");
  var errLog = require("debug")("nqmQuery:eventBusClient:error");
  ...
  EventBusClient.prototype.catchUp = function(key, since) {
    ...
    return new Promise(function(resolve) {
      log("asking server for catch-up of %s since %s",key,since);
